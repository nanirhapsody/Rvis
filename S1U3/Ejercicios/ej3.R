...
#Para este ejemplo calculamos la proporción de alturas entre 79 y 81 inches
exact <- mean(x > 79 & x <= 81)
#Ahora utiliza la aproximación normal para estimar la proporción de alturas entre 79 y 81 inches
